...
Existing Work:
Previous systems like OpenPose, VideoPose3D, and DeepMotion Animate 3D have focused on motion capture and 3D pose estimation for animation or VR purposes. However, these are typically designed for performance tracking rather than artistic reference and rarely combine pose and lighting extraction.
